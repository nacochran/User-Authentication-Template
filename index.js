...
// note: the original async/await method does not work because Passport's authenticate middle
// is not designed to work directly with asynchronous operations like await
passport.use(
  "google",
  new GoogleStrategy(
    {
